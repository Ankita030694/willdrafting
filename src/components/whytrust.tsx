    ...
    <section className="w-full bg-[#FAF7F0] py-8 sm:py-12 lg:py-16 flex justify-center">
      <div className="w-full max-w-[1400px] 2xl:max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <div className="relative w-full overflow-hidden min-h-[540px] sm:min-h-[600px] lg:min-h-[660px] flex flex-col justify-between p-7 sm:p-12 lg:p-16 shadow-[0_8px_32px_rgba(0,0,0,0.12)]">
          
          {/* Background Photography */}
          <Image
            src="/images/attorney-desk.jpg"
            alt="Attorney at desk reviewing legal documents"
            fill
            priority
          ...
          <div className="relative z-10 w-full text-left max-w-8xl mx-auto pt-2 sm:pt-4">
            <h2 className="text-[2.2rem] sm:text-[3.2rem] lg:text-[3.65rem] font-normal font-playfair font-serif text-[#FFFFFF] leading-[1.12] tracking-tight">
              You&apos;ll talk to your attorney.<br />
              <span className="italic font-normal">Not their assistant.</span>
            </h2>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 divide-y divide-white/20 md:divide-y-0 md:divide-x md:divide-white/20">
              {features.map((feature, idx) => (
                ...
                >
                  <div>
                    {/* Icon */}
                    <div className="mb-3.5 inline-block text-white">
                      {feature.icon}
                    </div>

                    {/* Title in Playfair Serif */}
                    <h3 className="text-[1.35rem] sm:text-[1.5rem] font-normal font-playfair font-serif text-white tracking-tight leading-snug mb-2.5">
                      {feature.title}
                    </h3>
                  </div>

                  {/* Description in Clean Sans - Solid White */}
                  <p className="text-[0.88rem] sm:text-[0.92rem] text-white leading-relaxed font-sans max-w-[340px]">
                    {feature.description}
                  </p>
                </div>
              ))}
